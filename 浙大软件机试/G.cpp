...
double getA(Mat Mf) {
	double r1 = 0.0;
	r1+=Mf.mat[0][0]*(Mf.mat[1][1]*Mf.mat[2][2]-Mf.mat[1][2]*Mf.mat[2][1]);
	r1+=Mf.mat[0][1]*(Mf.mat[1][0]*Mf.mat[2][2]-Mf.mat[1][2]*Mf.mat[2][0]);
	r1+=Mf.mat[0][2]*(Mf.mat[1][0]*Mf.mat[2][1]-Mf.mat[1][1]*Mf.mat[2][0]);
	return r1;
}
